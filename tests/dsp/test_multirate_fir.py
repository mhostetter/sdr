...
def test_3_2_20():
    ...
    """
    h = sdr.multirate_fir(3, 2, half_length=20)
    h_truth = np.array(
        [
            0,
            -0.000059208485371,
...
def test_2_3_20():
    ...
    """
    h = sdr.multirate_fir(2, 3, half_length=20)
    h_truth = np.array(
        [
            -0.000036875262276,
            0,
...
def test_3_2_15_120():
    ...
    """
    h = sdr.multirate_fir(3, 2, half_length=15, A_stop=120)
    h_truth = np.array(
        [
            0,
            0.000002676045758,
...
def test_2_3_15_120():
    ...
    """
    h = sdr.multirate_fir(2, 3, half_length=15, A_stop=120)
    h_truth = np.array(
        [
            0,
            -0.000004262029874,
